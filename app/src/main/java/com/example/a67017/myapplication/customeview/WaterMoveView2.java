 ...
 * @date 16/3/21
 */
public class WaterMoveView2 extends View {
    private Paint mPaint, nPaint, cPaint;
    ...
    public WaterMoveView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPath = new Path();
        nPath = new Path();
        dPath = new Path();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        */
        ...
        nPaint.setShader(shader);
        canvas.drawCircle(width / 2, height / 2, width / 2 - edge - paddingEdge, nPaint);
