...
import com.example.a67017.myapplication.tool.CameraHelper;
...
public class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private File getOutputMediaFile() {
        File mediaStorageDir = new File(Environment
                .getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), "LK");
        ...
        mediaFile = new File(mediaStorageDir.getPath() + File.separator + time + ".png");
        return mediaFile;
    }
